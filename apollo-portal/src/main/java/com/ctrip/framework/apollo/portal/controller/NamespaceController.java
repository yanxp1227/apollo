...
public class NamespaceController {
  ...
  @PreAuthorize(value = "@permissionValidator.hasCreateAppNamespacePermission(#appId, #appNamespace)") //校验是否有创建AppNamespace的权限
