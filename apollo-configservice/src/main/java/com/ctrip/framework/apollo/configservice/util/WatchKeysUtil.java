...
public class WatchKeysUtil {
  ...
  public Multimap<String, String> assembleAllWatchKeys(String appId, String clusterName,
                                                       ...
                                                       String dataCenter) {
    //组装 WatchedKeys Multimap   key:namespaceName  value:watchKey
    Multimap<String, String> watchedKeysMap =
   ...
   * @return Watch Key  => ReleaseMessage.message
   */
  ...
  private Set<String> assembleWatchKeys(String appId, String clusterName, String namespace,
                                        String dataCenter) {
    // appId 为 ApolloNoAppIdPlaceHolder 时返回 空集合
    ...
    //指定 Cluster
    // cluster name 不为 default 时 拼装"appId+clusterName+namespace" 添加到watchedKey中
